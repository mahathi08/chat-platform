...
const ServerRail = () => {
    ...
    return (
        <aside className="flex h-screen w-20 flex-col items-center justify-between border-r border-zinc-800 bg-[#1E1F22] py-4">
            ...
            <div className="flex w-full flex-col items-center gap-3">
                ...
                >
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-600 text-white transition-all duration-200 hover:rounded-xl hover:bg-indigo-500">
                        <Home size={22} />
                    </div>
                </button>
                ...
                {servers.map((server) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                className={`flex h-12 w-12 items-center justify-center overflow-hidden bg-zinc-700 text-lg font-bold text-white transition-all duration-200 ${
                                    active
                                        ? "rounded-2xl bg-indigo-600"
                                        : "rounded-full hover:rounded-2xl hover:bg-indigo-600"
                                }`}
                            >
